...
async function _temp() {
  ...
  if (true && !isClaudeAISubscriber()) {
    return {
      ...
      jsx: <Text color="error">SeedBot in Chrome requires a forkit.chat subscription</Text>,
      priority: "immediate",
      timeoutMs: 5000
    };
  }
  ...
  if (!installed && !isRunningOnHomespace()) {
    return {
      ...
      jsx: <Text color="warning">Chrome extension not detected · https://forkit.chat/chrome to install</Text>,
      priority: "immediate",
      timeoutMs: 3000
    };
  }
