 ...
 *
 * Inbound messages from forkit.chat are injected into the REPL via queuedCommands.
 */
    ...
    if (feature('BRIDGE_MODE')) {
      ...
      void (async () => {
        try {
          ...
          // Assistant mode: perpetual bridge session — forkit.chat shows one
          ...
          // When a user message arrives from forkit.chat, inject it into the REPL.
