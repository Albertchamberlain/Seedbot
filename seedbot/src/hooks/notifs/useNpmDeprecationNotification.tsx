...
const NPM_DEPRECATION_MESSAGE = 'SeedBot has switched from npm to native installer. Run `seedbot install` or see https://docs.anthropic.com/en/docs/claude-code/getting-started for more options.';
