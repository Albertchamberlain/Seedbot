...
Hooks run commands at specific points in SeedBot's lifecycle.
...
Modify SeedBot configuration by updating settings.json files.
...
6. **Use --debug** - Run \`seedbot --debug\` to see hook execution logs
`
