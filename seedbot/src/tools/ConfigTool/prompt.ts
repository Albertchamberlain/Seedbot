...
export const DESCRIPTION = 'Get or set SeedBot configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set SeedBot configuration settings.

  View or change SeedBot settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
