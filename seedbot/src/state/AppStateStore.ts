...
export type AppState = DeepImmutable<{
  ...
  // Remote session WS state (`seedbot assistant` viewer). 'connected' means the
  ...
  remoteConnectionStatus:
    ...
    | 'reconnecting'
    | 'disconnected'
  // `seedbot assistant`: count of background tasks (Agent calls, teammates,
  ...
  // Always-on bridge: ingress WebSocket is open (= "Connected" - user on forkit.chat)
  ...
  // Always-on bridge: session URL on forkit.chat (set when connected)
