...
// Always ask when SeedBot tries to edit its own config files
 ...
 * This is a per-user temporary directory used by SeedBot for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by SeedBot)
