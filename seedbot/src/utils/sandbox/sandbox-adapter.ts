...
/**
 * Resolve SeedBot-specific path patterns for sandbox-runtime.
 *
 * SeedBot uses special path prefixes in permission rules:
...
/**
 * Convert SeedBot settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where SeedBot started)
