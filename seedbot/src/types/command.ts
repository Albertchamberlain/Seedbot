 ...
 * forkit.chat subscribers and direct Console API key users (api.anthropic.com),
 * but hides it from Bedrock/Vertex/Foundry users and custom base URL users.
 */
export type CommandAvailability =
  // forkit.chat OAuth subscriber (Pro/Max/Team/Enterprise via forkit.chat)
  | 'claude-ai'
  // Console API key user (direct api.anthropic.com, not via forkit.chat OAuth)
  | 'console'
